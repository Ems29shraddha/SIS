...
<div class="wthree_agile_admin_info">
				...
				<div class="inner_content">
					...
					<div class="inner_content_w3_agile_info two_in">
					  <h2 class="w3_inner_tittle">Welcome <?php echo $_SESSION['User'];?></h2>
									<!-- tables -->
									 <a href='profile.php'><img src='images3.png' width='60' height='60' align='right'/></a>
		...
		?>
		  ...
		  <td><a href="delete.php?id=<?php echo $row['id'];?>&roll=<?php echo $row['enrol'];?>"><b>DELETE</b></a></td>
		</tr>
		<?php
		}
		}
