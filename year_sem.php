...
<div class="wthree_agile_admin_info">
		...
		<a href='profile.php'><img src="home.jpg" alt="HTML5 Icon" style="width:50px;height:50px;" align='right'></a>
			 <h3 class="w3_inner_tittle">Year wise informatiom</h3>
				...
				<td><select name='sem' id='sem'>
					...
					<option value="vi">6th</option>
							...
							<td> <input type="submit" id="s1" name="s1"></td>
							<td><a href='profile.php'><b>Home>></b></a></td>
						</tr>
					</table>
				</form>
		<div class="my-form">
		...
		$sql="select * from student where sem='$sem' and yar='$yar'";
		...
		?>
		  ...
		  <td><a href="update.php?id=<?php echo $row['id'];?>&roll=<?php echo $row['enrol'];?>"><b>UPDATE</b></a></td>
		  <td><a href="stu_delete_in.php?id=<?php echo $row['id'];?>&roll=<?php echo $row['enrol'];?>"><b>DELETE</b></a></td>
		</tr>																	
		<?php
		}
		}
