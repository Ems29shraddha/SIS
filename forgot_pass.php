...
<html lang="zxx">
<head>
<title>Student Database Managment System | Admin Login  :: </title>
<!-- custom-theme -->
<meta name="viewport" content="width=device-width, initial-scale=1">
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
<meta name="keywords" content="Student Database Managment System" />
...
<div class="wthree_agile_admin_info">
		  ...
		  <div class="w3_agileits_top_nav">
			<ul id="gn-menu" class="gn-menu-main">
				...
				<!-- //nav_agile_w3l -->
                <li class="second logo admin"><h1><a href="index.html"><i class="fa fa-graduation-cap" aria-hidden="true"></i>GPCB </a></h1></li>
												...
												<div class="signin-form profile admin">
													...
													<div class="login-form">
														...
														<input type="text" name="email" id="email" value="" placeholder="Email" required="">
															<input type="text" name="mob" id="mob" value="" placeholder="Mobile No" required="">
															<input type="text" name="nic" id="nic" placeholder="Nic Name" value="" required="">
															<div class="tp">
...
$sql="select * from admin where mob='$mob' and nic='$nic' and email='$email'";
$result = mysql_query($sql,$con);
$records = mysql_num_rows($result);
$row = mysql_fetch_array($result);
if ($records==0)
{
echo '<script type="text/javascript">alert("Wrong Mobile or Nic Name");window.location=\'forgot_pass.php\';</script>';
}
else
{
